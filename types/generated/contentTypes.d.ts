...
export interface ApiBookingBooking extends Schema.CollectionType {
  ...
  attributes: {
    Email_client: Attribute.Email;
    Telephone_client: Attribute.BigInteger;
    Date_de_reservation: Attribute.DateTime;
    Cours: Attribute.Relation<
      'api::booking.booking',
      'manyToOne',
      'api::course.course'
    >;
    Status: Attribute.Enumeration<['pending', 'confirmed']>;
    paiements: Attribute.Relation<
      'api::booking.booking',
      'oneToMany',
      'api::payment.payment'
    >;
...
export interface ApiCourseCourse extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Code: Attribute.UID<'api::course.course', 'Nom'>;
